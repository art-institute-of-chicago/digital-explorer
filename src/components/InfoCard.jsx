...
export default function InfoCard({
    ...
    if (isToggled) {
      ...
      if (isVOModeActive) {
        const titleText = stripHtml(
          infoCardData?.info_title || "Digital Explorer",
        );
  ...
  return (
    <div style={styles.container}>
      ...
      >
        <img
          src={isToggled ? closeIcon : infoIcon}
          alt=""
          style={{ width: "100%" }}
          aria-hidden="true"
        />
          ...
          <div>
            <h2
              ...
              dangerouslySetInnerHTML={{
                __html: infoCardData?.info_title || "Digital Explorer",
              }}
            />
            <div
              style={styles.description}
              dangerouslySetInnerHTML={{
                __html: infoCardData?.info_description || "",
              }}
            />
          </div>
          <div
            ...
            dangerouslySetInnerHTML={{
              __html:
                infoCardData?.info_credits ||
                `Art Institute of Chicago | ${new Date().getFullYear()}`,
            }}
          />
        </section>
      )}
